      ...
      <form id="expenditureForm" action="Regist1Servlet" method="post">
        ...
        <div class="form-row">
          <div class="field-group">
            ...
            <div class="field-wrap">
              ...
              <input class="input-field" type="date" id="created_at" name="created_at" placeholder="日付を入力してください" value="">
              	<div class="error-msg" id="errDate"
				    style="${not empty errDate ? 'display:block;' : ''}">
				    日付を入力してください
				</div>
            </div>
            ...
            <div class="field-wrap">
              ...
              <input class="input-field" type="text" id="amount" name="amount" placeholder="金額を入力してください" value="">
              	...
              	<div class="error-msg" id="errAmount"
				    style="${not empty errAmount ? 'display:block;' : ''}">
				    金額を入力してください
				</div>
            ...
            </div><div class="error-msg" id="errItemName" style="display:none;">商品名を入力してください</div>
          ...
          <div class="field-wrap" style="margin-bottom:8px;">
           ...
           <div class="error-msg" id="errTag" style="display:none;">タグを選択してください</div>
          </div>
          </div>
        ...
        <div class="field-wrap" style="margin-bottom:8px;">
          ...
          <div class="error-msg" id="errCategory" style="display:none;">カテゴリを選択してください</div>
        </div>
		...
		<div class="error-msg" id="errSituation" style="display:none;">状況を選択してください</div>
		</div>
